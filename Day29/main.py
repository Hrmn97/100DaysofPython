...
# that appear right after the definition of a function, method, class, or module.
...
# function, method, class, or module (like in Example 1). They are used to document our code.
